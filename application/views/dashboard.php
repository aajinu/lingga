    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Selamat Datang Di halaman Admin.</h2>

                    <!-- Dynamic Table Full -->
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">User <small>Admin</small></h3>
                        </div>
                        <div class="block-content block-content-full">
                            <form action="<?= base_url('welcome/tambah') ?>" method="post" class="form-group">
                                <input type="hidden" name="username" class="form-control" placeholder="username">
                                <input type="hidden" name="password" class="form-control" placeholder="password">
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"><?= $a->id_admin ?></td>
                                        <td class="font-w600"><?= $a->username ?></td>
                                        <td class="font-w600"><a href="<?= base_url('admin/edit/'.$a->id_admin) ?>" class="btn btn-alt-primary">Edit</a></td>
                                    </tr>
                                    <?php endforeach ?>
                                </tbody>
                            </table>
