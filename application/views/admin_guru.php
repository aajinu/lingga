            ...
            <main id="main-container">
                ...
                <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Guru</h3>                            
                        </div>
                        <div class="block-content">
                        <?php foreach ($guru as $g): ?>
                            <form action="<?= base_url('admin/ubah_guru') ?>" method="post" class="form-group">                                    
                                    <label for="side-overlay-profile-email">guru</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="guru" placeholder="" value="<?= $g->guru ?>">
                                    </div>
                                    <label for="side-overlay-profile-email">username</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="username" placeholder="" value="<?= $g->username ?>">
                                    </div>
                                    <label for="side-overlay-profile-email">Judul 3</label>
                                    <div class="input-group">
                                        <input type="password" class="form-control" name="password" placeholder="" value="<?= $g->password ?>">
                                    </div><br>
