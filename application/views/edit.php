                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <form action="<?= base_url('admin/proses_edit') ?>" method="post" class="form-group">
                                <input type="hidden" name="id" class="form-control" value="<?= $kode_admin ?>">
                                <input type="text" name="username" class="form-control" value="<?= $a->username ?>" placeholder="username">
                                <input type="text" name="password" class="form-control" value="<?= $a->password ?>" placeholder="password">
                                <input type="text" name="email" class="form-control" value="<?= $a->email ?>" placeholder="email">
