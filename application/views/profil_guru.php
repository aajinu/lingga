            ...
            <div class="content">
                ...
                <div class="block">                
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Ubah Profil Guru</h3>                            
                        </div>
                        <div class="block-content">
                            <p>Lengkapi data di bawah ini untuk menambahkan informasi ke Profil anda.</p>
                            <hr>
                            <form action="<?= base_url('welcome/ubah_profil_guru') ?>" method="post" class="" enctype="multipart/form-data">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                        <input type="hidden" name="id" class="form-control" value="<?= $admin->id_guru ?>">                     
                                        <div class="form-group row">
