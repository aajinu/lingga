            ...
            <nav id="sidebar">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <!-- Side User -->
                        <?php include "side_user_admin.php";?>
                        <!-- END Side User -->
                ...
                <div class="block">
                        ...
                        <div class="block-content">
                            <div class="form-group">
                                <button id="addToTable" class="btn btn-danger" data-toggle="modal" data-target="#con-close-modal">Tambah Siswa <i class="fa fa-plus"></i></button>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                ...
                                <?php $i=1; foreach ($siswa as $a): ?>
                                
                                    <tr>
                                        <td class="text-center"><?= $i ?></td>
                                        <td class="d-none d-sm-table-cell"><?= $a->nama ?></td>
                                        <td class="d-none d-sm-table-cell"><?= $a->username ?></td>
                                        <td class="font-w600">
                                            <button type="button" class="btn btn-alt-primary" data-toggle="modal" data-target="#modal-default<?= $a->id_siswa ?>">
                                                Edit
                                            </button>
                                        </td>
                                        <td class="font-w600"><a href="<?= base_url('admin/hapus_siswa/'.$a->id_siswa) ?>" onclick="return confirm('hapus ?')" class="btn btn-alt-danger">Hapus</a></td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="<?= base_url('admin/ubah_siswa') ?>" method="post" class="" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" name="password" placeholder="" value="<?= $a->password ?>">
                                    </div>
                                    <br>
                        ...
                        <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog"> 
                                <div class="modal-content"> 
                                    ...
                                    <div class="block-content">
                            <form action="<?= base_url('admin/tambah_siswa') ?>" method="post" class="form-group" enctype="multipart/form-data">
