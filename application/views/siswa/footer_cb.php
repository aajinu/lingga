            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-left">
                        <a class="font-w600" href="<?= base_url('admin') ?>">Sistem Identifikasi Masalah Siswa</a> &copy; <span class="js-year-copy">2017</span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
        ...
        <!-- Page JS Plugins -->
        <script src="<?= base_url('assets/admin/') ?>js/plugins/bootstrap-wizard/jquery.bootstrap.wizard.js"></script>
        <script src="<?= base_url('assets/admin/') ?>js/plugins/jquery-validation/jquery.validate.min.js"></script>
        <script src="<?= base_url('assets/admin/') ?>js/plugins/jquery-validation/additional-methods.min.js"></script>

        <!-- Page JS Code -->
        <script src="<?= base_url('assets/admin/') ?>js/pages/be_forms_wizard.js"></script>
    </body>
</html>