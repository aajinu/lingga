                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="index.html">
                                        <span class="font-size-xl text-dual-primary-dark">Selamat </span><span class="font-size-xl text-primary">Datang</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="content-side content-side-full content-side-user px-10 align-parent">
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                <a class="img-link" href="<?= base_url('admin'); ?>">
                                    <img class="img-avatar" src="<?= base_url('assets/admin/') ?>img/avatars/avatar15.jpg" alt="">
                                </a>
                                <ul class="list-inline mt-10">
                                    <li class="list-inline-item">
                                        <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="be_pages_generic_profile.html"><?= $admin->username; ?></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <!-- Layout API, functionality initialized in Codebase() -> uiApiLayout() -->
                                    ...
                                    <li class="list-inline-item">
                                        <a class="link-effect text-dual-primary-dark" href="<?= base_url('welcome/logout'); ?>" onclick="return confirm('Anda yakin ingin keluar ?')">
                    ...
                    <div class="content-header-section">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?= $admin->username ?><i class="fa fa-angle-down ml-5"></i>
                            </button>
